...
1. [*案例：*列表转JSON](#list2json)
1. [*案例：*JSON转列表](#json2list)
...
***
### 案例：列表转JSON  {#list2json}

  列表 -> 字典 -> 字典赋值给文本，文本内容自动就是JSON格式字符串。参考代码如下：

  ![](images/lists/列表转JSON.png){:.vip}

***
### 案例：JSON转列表  {#json2list}

  Web客户端 -> 列表，参考代码如下：
  
  ![](images/lists/JSON转列表.png)
