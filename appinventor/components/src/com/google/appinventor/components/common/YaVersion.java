...
public class YaVersion {
  ...
  public static final String EMULATOR_UPDATE_URL = "/reference/info/Emulator.apk"; // Should be an APK
  public static final String COMPANION_UPDATE_URL = "/reference/info/AI2Companion.html";
  public static final String COMPANION_UPDATE_URL1 = "/reference/info/AI2Companion.html";
