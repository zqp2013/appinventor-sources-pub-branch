    ...
    <div class="container-fluid">
            ...
            <div class="card shadow" style="max-height: 1000px;
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">title:<c:out value="${aia.title}" /></h4>
                        <p class="card-text"><i><c:out value="${aia.publish_time}" /></i>&nbsp;Likes:&nbsp;<span id="like_841d90c3-42de-4531-969e-6c580b45a154">0</span>
